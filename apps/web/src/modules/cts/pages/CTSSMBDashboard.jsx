/**
 * CTSSMBDashboard — landing page for SMB (Sub-Member Bank) users.
 *
 * SMB users see only their own bank's clearing activity. This page is the
 * first screen after login and surfaces:
 *   - SMB identity header (bank name, IFSC, sponsor bank, zone)
 *   - Today's inward summary (vol, STP rate, pending, IET-at-risk)
 *   - In-flight IET countdown for any items approaching deadline
 *   - Recent decisions (last 5)
 *   - Quick-action links (Review Queue, Inward Pipeline, Settlement)
 *
 * smbOnly: SB users never see this page (AppShell gate).
 */
