...
const BASE_INSTRUMENTS_OUTWARD = [
  {
    instrument_id: 'CHQ-OUT-V001', source_stage: 'STP', front_bw_url: demoChequeUrl(0), front_gray_url: demoChequeUrl(1), drawee_bank: 'State Bank of India', drawee_branch: 'Andheri East',
  ...
  {
    instrument_id: 'CHQ-OUT-V002', source_stage: 'VERIFIED', front_bw_url: demoChequeUrl(2), front_gray_url: demoChequeUrl(3), drawee_bank: 'HDFC Bank', drawee_branch: 'Bandra West',
  ...
  {
    instrument_id: 'CHQ-OUT-V003', source_stage: 'STP', front_bw_url: demoChequeUrl(4), front_gray_url: demoChequeUrl(5), drawee_bank: 'ICICI Bank', drawee_branch: 'Powai',
  ...
  {
    instrument_id: 'CHQ-OUT-V004', source_stage: 'VERIFIED', front_bw_url: demoChequeUrl(6), front_gray_url: demoChequeUrl(7), drawee_bank: 'Bank of Baroda', drawee_branch: 'Fort',
  ...
  {
    instrument_id: 'CHQ-OUT-V005', source_stage: 'STP', front_bw_url: demoChequeUrl(8), front_gray_url: demoChequeUrl(9), drawee_bank: 'Axis Bank', drawee_branch: 'Goregaon',
...
const BASE_INSTRUMENTS_INWARD = [
  {
    ...
    instrument_id: 'CHQ-IN-V001', source_stage: 'STP', front_bw_url: demoChequeUrl(10), front_gray_url: demoChequeUrl(11),
  ...
  },
  {
    ...
    instrument_id: 'CHQ-IN-V002', source_stage: 'VERIFIED', front_bw_url: demoChequeUrl(12), front_gray_url: demoChequeUrl(13),
  ...
  },
  {
    ...
    instrument_id: 'CHQ-IN-V003', source_stage: 'STP', front_bw_url: demoChequeUrl(14), front_gray_url: demoChequeUrl(15),
  ...
  },
  {
    ...
    instrument_id: 'CHQ-IN-V004', source_stage: 'VERIFIED', front_bw_url: demoChequeUrl(16), front_gray_url: demoChequeUrl(17),
