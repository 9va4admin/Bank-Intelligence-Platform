...
const MOCK_HUMAN_REVIEW = [
  {
    ...
    amount_range: '₹[5L-10L]', micr: '680001002841', bank: 'Federal Bank Limited',
    ...
    scanner_id: 'SCN-THR-02', lot_number: 'LOT_FDRL0000001_20260811_01',
  ...
  },
  {
    ...
    amount_range: '₹[1L-5L]', micr: '682001002855', bank: 'Federal Bank Limited',
    ...
    scanner_id: 'SCN-ERN-01', lot_number: 'LOT_FDRL0000001_20260811_02',
...
const MOCK_STP_REJECTED = [
  {
    ...
    amount_range: '₹[1L-5L]', micr: '680001002771', bank: 'Federal Bank Limited',
    branch: 'Aluva', pu: 'SOUTH-MAIN', bank_slug: 'federal-bank',
    reason: 'CTS_COMPLIANCE_FAILURE', reason_label: 'CTS compliance failure — auto-rejected', received_at: '10:58 AM',
    scanner_id: 'SCN-ALV-01', lot_number: 'LOT_FDRL0000001_20260811_01',
