...
async def mark_leaf_presented(
    ...
    """
    with tracer.start_as_current_span("activity.mark_leaf_presented") as span:
...
async def mark_leaf_paid(
    ...
    """
    with tracer.start_as_current_span("activity.mark_leaf_paid") as span:
        span.set_attribute("bank_id", inp.bank_id)
        span.set_attribute("instrument_id", inp.instrument_id)
        try:
...
async def mark_leaf_returned(
    ...
    """
    with tracer.start_as_current_span("activity.mark_leaf_returned") as span:
        span.set_attribute("bank_id", inp.bank_id)
        span.set_attribute("instrument_id", inp.instrument_id)
        try:
...
async def sweep_expired_leaves(
    ...
    """
    with tracer.start_as_current_span("activity.sweep_expired_leaves") as span:
        span.set_attribute("bank_id", inp.bank_id)
